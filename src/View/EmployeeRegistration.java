...
DefaultTableModel Model;
    ...
    public EmployeeRegistration() {
     ...
     private void addItemCombo(){
       try{
            ...
            List<RepairJob> theRepairJob= Service.repairjoblldata();
            for(RepairJob RepairJob : theRepairJob){
                RepairCombo.addItem(RepairJob);
       ...
       try {
            ...
            List<Employee> employeeList = service.employeealldata();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Search, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 160, -1, -1));
        ...
        EmployeeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee ID", "Names", "Phone Number", "RepairJob "
            }
        ));
        jScrollPane1.setViewportView(EmployeeTable);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 440, 280));
        ...
        getContentPane().add(employeeIdTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, 140, 30));
        ...
        RepairCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RepairComboActionPerformed(evt);
            }
        });
        getContentPane().add(RepairCombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 140, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Wallpaper/Background 2.jpg"))); // NOI18N
 ...
 try{
    ...
    RepairJob theRepairJob = (RepairJob) RepairCombo.getSelectedItem();
    theEmployee.setRepairJobs((List<RepairJob>) theRepairJob);
    Employee ReObj = Service.RegisterEmployee(theEmployee);
    ...
    String employeeIdText = employeeIdTxt.getText();

    // Check if the input string is not empty before parsing
    if (!employeeIdText.isEmpty()) {
        int employeeIdValue = Integer.parseInt(employeeIdText);

        // Create a Customer object and set its ID
        Employee searchEmployeeObj = new  Employee();
        searchEmployeeObj.setEmployeeId(employeeIdValue);
    ...
    EmployeeService service = (EmployeeService) theRegistry.lookup("Employee");
       ...
       Employee empObj = service.searching( searchEmployeeObj);

        // If the customer object is found, populate the text fields
        if (empObj != null) {
            NamesTxt.setText(empObj.getNames());
            PhoneTxt.setText(empObj.getPhoneNumber());
            ...
            JOptionPane.showMessageDialog(this, "Employee not found for the entered ID");
        }
    } else {
 ...
 HomePage hm=new HomePage();
  ...
  try {
    ...
    int EmployeeIdValue = Integer.parseInt(employeeIdTxt.getText());
    
    // Create a Customer object and set its properties
    Employee Empobj = new Employee();
    Empobj.setEmployeeId(EmployeeIdValue);
    ...
    Employee isDeleted = service.DeleteEmployee(Empobj);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
           try {
    int EmployeeIdValue = Integer.parseInt(employeeIdTxt.getText());
   Employee updatedEmployeeObj = new  Employee();
    
    updatedEmployeeObj.setEmployeeId(EmployeeIdValue);
    updatedEmployeeObj.setNames(NamesTxt.getText());
   updatedEmployeeObj.setPhoneNumber(PhoneTxt.getText());
   ...
   Employee EmpObj = Service.UpdateEmployee(updatedEmployeeObj);
 ...
 MessageFormat header = new MessageFormat("Employee management List");
       ...
       EmployeeTable.print(JTable.PrintMode.FIT_WIDTH, header, footer, true, set, true);
    ...
    private void RepairComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RepairComboActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_RepairComboActionPerformed
    ...
    private javax.swing.JComboBox<RepairJob> RepairCombo;
